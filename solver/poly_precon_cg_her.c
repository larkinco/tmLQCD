...
#include "poly_precon_cg_her.h"

/* P output = solution , Q input = source */
int poly_precon_cg_her(spinor * const P, spinor * const Q, const int max_iter, 
	               double eps_sq, const int rel_prec, const int N, 
                       matrix_mult f, double evmin, double evmax, int cheb_k) {
